...
class BorzoiSNPInferencer(BorzoiInferencer):
    ...
    def infer_snp(
        ...
        assert ref_data.shape[1] == len(combined_bed), "Mismatch between prediction regions and bed file rows"
    ...
    def calculate_peak_effect(self, ds):
        ...
        peak_values = np.zeros((num_samples, num_regions, num_channels, 16))
        ...
        for region_idx in range(num_regions):
            ...
            peak_effect = region_effect[:, :, start_idx:start_idx+16]
