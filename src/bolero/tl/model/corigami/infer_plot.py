    ...
    def infer(self):
        ...
        with torch.inference_mode():
            ...
            for _, batch in enumerate(dataloader):
                ...
                # insulation_counter.append(insulation_score)
            ...
            # single_batch_insulation_score = np.mean(insulation_counter)
            score_dict = {
                "single_batch_pearson": single_batch_pearson,
                "across_batch_pearson": across_batch_pearson,
                # "single_batch_insulation_score": single_batch_insulation_score,
            }
