...
def main():
    ...
    config = {
        ...
        "window_size": 524288,
        "step": 40000,
        "bed": '/large_storage/zhoulab/yishuang/project/bolero/tests/corigami/inference/temp.bed',
        ...
        # training
        "mode": args.mode,
        "pretrained_model": f"/large_storage/zhoulab/yishuang/project/bolero/tests/corigami/training/{args.checkpoint_folder}/{args.mode}.{args.mode}.best_checkpoint.pt",
        ...
        "lora_dropout": 0.01,
        # save data
        "output_dir": f"/large_storage/zhoulab/yishuang/project/bolero/tests/borzoi/{inference_folder}/{cell_type}",
