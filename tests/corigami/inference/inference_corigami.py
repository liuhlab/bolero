...
def main():
    ...
    if args.mode == 'lora_finetune':
        inference_folder = 'inference_lora'
    elif args.mode == "conditional_lora_finetune":
        inference_folder = "inference_conditional_lora"
    else:
        if args.no_training:
            inference_folder = "inference_no_training"
        else:
            inference_folder = "inference_pretrained"
